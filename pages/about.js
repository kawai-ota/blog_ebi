    ...
    <Container>
      ...
      <TwoColumn>
        <TwoColumnMain>
          <PostBody>
            <p>
              Cubeが得意としている分野はものづくりです。3次元から2次元の造形、プログラミングや
              デザインなど、様々な技術を組み合わせることによって社会や環境と結びつけるクリエイティブを提案し続けています。
            </p>
            <h2>もの作りで目指していること</h2>
            <p>
...
//containerコンポーネントで大枠のCSSを適用させておくとPostコンポーネントが適用されなくなるので注意
